  ...
  return (
    <div className="card">
      ...
      <div className="card-body">
          ...
          <div className="col-md-6">
            <div className="card shadow-none">
              <div className="card-body px-0">
                ...
                <p>
                  <a href="#!" className="btn-link small">Edit</a>
                  <span className="mx-2">|</span>
                  <a href="#!" className="btn-link small">Change Password</a>
                </p>
              </div>
            </div>
          </div>
        ...
        <h6>Address Book <Link to="/dashboard/address" className="btn-link small ml-3">Manage Addresses</Link></h6>
        <hr />
        <div className="row">
          <div className="col-md-6">
            <div className="card shadow-none">
