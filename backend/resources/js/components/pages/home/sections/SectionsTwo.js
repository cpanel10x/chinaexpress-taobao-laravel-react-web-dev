...
const SectionsTwo = (props) => {
	...
	const section_two_title = settings?.section_two_title || '';
	const query_url = settings?.section_two_query_url || '';
	const query_type = settings?.section_two_query_type || '';
			...
			<div className="card my-5">
				<div className="card-body">
					<div className="row mt-2 mb-0 mb-md-2 mb-md-3">
						<div className="col-6">
							<h3 className="title "> {section_two_title}</h3>
						</div>
