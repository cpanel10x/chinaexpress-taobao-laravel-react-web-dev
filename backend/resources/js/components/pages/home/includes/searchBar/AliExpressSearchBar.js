				...
				<div className="aliExpressSearchBar mt-4">
					<div className=" row align-items-center">
						<div className="col-md-3 d-none d-md-block">
							<img src={`/img/aliExpress.gif`} className="img-fluid aliExpressLogo" alt="aliExpress"/>
						</div>
						<div className="col-md-9 aliSearchFormCol">
							<img src={`/img/paste-aliExpress-link.gif`} className="img-fluid aliExpressText" alt="aliExpressText"/>
							<form
