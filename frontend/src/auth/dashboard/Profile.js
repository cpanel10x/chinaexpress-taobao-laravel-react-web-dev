							...
							<div className="card my-3">
								<div className="card-body">
											...
											<td>
												{
													user.avatar_type === 'gravatar' ?
														<img src={`https://www.gravatar.com/avatar/404`} style={{width: '4rem'}} alt={user.name}/>
														:
														<img src={user.avatar_type} style={{width: '4rem'}} alt={user.name}/>
												}
											</td>
										</tr>
									...
									<button
										...
										className="btn btn-default">Edit Profile
									</button>
